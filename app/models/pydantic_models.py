...
class HomeListingCreate(BaseModel):
      ...
      property_type: Literal["apartment", "detached_house", "terrace_house", "duplex", "studio", "cottage", "loft", "cabin", "other"] 
...
class ImageMetadataCollection(BaseModel):
      ...
      deleted_public_urls: Optional[List[Annotated[str, Field(max_length=2048)]]] = Field(default_factory=list)
