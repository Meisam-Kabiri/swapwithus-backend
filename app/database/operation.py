...
class DbManager:
    @staticmethod
    async def create_record_in_table(pool: asyncpg.Pool, data: dict, table_name: str) -> None:
        """
        Insert record from dict into specified table
        """
    ...
    @staticmethod
    async def update_record_in_table(
        pool: asyncpg.Pool,
        data: dict,
        table_name: str,
        where_column: str,
